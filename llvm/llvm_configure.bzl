    ...
    _tpl(repository_ctx, "BUILD", {
        ...
        "%{CLANG_CODEGEN_LIB}":
            _llvm_get_library_rule(ctx, prx, "clang_code_gen",
                "clangCodeGen",
                ["clang_analysis", "clang_ast", "clang_basic",
                 "clang_frontend", "clang_lex", "clang_serialization",
                 "llvm_analysis", "llvm_bit_reader", "llvm_bit_writer",
                 "llvm_core", "llvm_coroutines", "llvm_coverage",
                 "llvm_extensions", "llvm_frontend_open_mp", "llvm_ipo",
       ...
       "%{LLVM_ORCTARGETPROCESS_LIB}":
        ...
        "%{MLIR_AFFINETRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_affine_transforms",
                ...
                ["mlir_affine", "mlir_affine_utils", "mlir_edsc",
                 "mlir_ir", "mlir_pass", "mlir_side_effect_interfaces",
                 "mlir_standard", "mlir_transform_utils", "mlir_vector",
                 "mlir_vector_to_llvm", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_AFFINEUTILS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_affine_utils",
                "MLIRAffineUtils",
                ["mlir_affine", "mlir_transform_utils", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ANALYSIS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_analysis",
                "MLIRAnalysis",
                ["mlir_affine", "mlir_call_interfaces",
                 "mlir_control_flow_interfaces", "mlir_infer_type_op_interface",
                 "mlir_scf", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ARMNEON_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_arm_neon",
                "MLIRArmNeon",
                ["mlir_ir", "mlir_side_effect_interfaces", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ARMNEONTOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_arm_neon_to_llvm",
                "MLIRArmNeonToLLVM",
                ["mlir_arm_neon", "mlir_llvm_arm_neon", "mlir_llvm_ir",
                 "mlir_standard_to_llvm", "mlir_transforms", "llvm_core",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ARMSVE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_arm_sve",
                "MLIRArmSVE",
                ["mlir_ir", "mlir_side_effect_interfaces", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ARMSVETOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_arm_sve_to_llvm",
                "MLIRArmSVEToLLVM",
                ["mlir_arm_sve", "mlir_llvm_arm_sve", "mlir_llvm_ir",
                 "mlir_standard_to_llvm", "mlir_transforms", "llvm_core",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ASYNC_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_async",
                "MLIRAsync",
                ["mlir_dialect", "mlir_ir", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ASYNCRUNTIME_LIB}":
            _llvm_get_shared_library_rule(ctx, prx, "mlir_async_runtime",
                "mlir_async_runtime",
                ["mlir_c_runner_utils_static", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ASYNCRUNTIME_COPY_GENRULE}":
            _llvm_get_shared_lib_genrule(ctx, prx, "mlir_copy_async_runtime",
                llvm_path, "mlir_async_runtime"),
        "%{MLIR_ASYNCTOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_async_to_llvm",
                "MLIRAsyncToLLVM",
                ["mlir_async", "mlir_llvm_ir", "mlir_standard_ops_transforms",
                 "mlir_standard_to_llvm", "mlir_transforms", "llvm_core",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ASYNCTRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_async_transforms",
                "MLIRAsyncTransforms",
                ["mlir_async", "mlir_ir", "mlir_pass", "mlir_scf",
                 "mlir_transform_utils", "mlir_transforms",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_AVX512_LIB}":
        ...
        "%{MLIR_CALLINTERFACES_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_call_interfaces",
                ...
                ["mlir_ir", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPIIR_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_ir",
                "MLIRCAPIIR",
                ["mlir_ir", "mlir_parser", "mlir_pass", "mlir_support",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPILINALG_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_linalg",
                "MLIRCAPILinalg",
                ["mlir_capi_ir", "mlir_linalg", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPIREGISTRATION_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_registration",
                "MLIRCAPIRegistration",
                ["mlir_affine", "mlir_affine_edsc", "mlir_affine_transforms",
                 "mlir_affine_utils", "mlir_arm_neon", "mlir_arm_sve",
                 "mlir_async", "mlir_async_transforms", "mlir_avx512",
                 "mlir_capi_ir", "mlir_complex", "mlir_gpu",
                 "mlir_llvm_arm_neon", "mlir_llvm_arm_sve", "mlir_llvm_avx512",
                 "mlir_llvm_ir", "mlir_llvm_ir_transforms", "mlir_linalg",
                 "mlir_linalg_analysis", "mlir_linalg_edsc",
                 "mlir_linalg_transforms", "mlir_linalg_utils", "mlir_nvvm_ir",
                 "mlir_open_acc", "mlir_open_mp", "mlir_pdl", "mlir_pdl_interp",
                 "mlir_quant", "mlir_rocdl_ir", "mlir_scf",
                 "mlir_scf_transforms", "mlir_sdbm", "mlir_spirv",
                 "mlir_spirv_conversion", "mlir_spirv_module_combiner",
                 "mlir_spirv_transforms", "mlir_spirv_utils", "mlir_shape",
                 "mlir_shape_ops_transforms", "mlir_standard",
                 "mlir_standard_ops_transforms", "mlir_tensor",
                 "mlir_tensor_transforms", "mlir_tosa", "mlir_tosa_transforms",
                 "mlir_vector", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPISCF_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_scf",
                "MLIRCAPISCF",
                ["mlir_capi_ir", "mlir_scf", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPISHAPE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_shape",
                "MLIRCAPIShape",
                ["mlir_capi_ir", "mlir_shape", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPISTANDARD_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_standard",
                "MLIRCAPIStandard",
                ["mlir_capi_ir", "mlir_standard", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPITENSOR_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_tensor",
                "MLIRCAPITensor",
                ["mlir_capi_ir", "mlir_tensor", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CAPITRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_capi_transforms",
                "MLIRCAPITransforms",
                ["mlir_transforms", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_CASTINTERFACES_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_cast_interfaces",
                "MLIRCastInterfaces",
                ["mlir_ir", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_COMPLEX_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_complex",
                "MLIRComplex",
                ["mlir_dialect", "mlir_ir", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_COMPLEXTOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_complex_to_llvm",
                "MLIRComplexToLLVM",
                ["mlir_complex", "mlir_llvm_ir", "mlir_standard_ops_transforms",
        ...
        "%{MLIR_COPYOPINTERFACE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_copy_op_interface",
                "MLIRCopyOpInterface",
                ["mlir_ir", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_EXECUTIONENGINE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_execution_engine",
                ...
                ["mlir_llvm_ir", "mlir_target_llvm_ir",
                 "llvm_core", "llvm_coroutines", "llvm_execution_engine",
                 "llvm_object", "llvm_orc_jit", "llvm_jit_link",
                 "llvm_analysis", "llvm_aggressive_inst_combine",
                 "llvm_inst_combine", "llvm_mc", "llvm_scalar", "llvm_target",
        ...
        "%{MLIR_GPU_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_gpu",
                "MLIRGPU",
                ["mlir_async", "mlir_edsc", "mlir_ir", "mlir_llvm_ir",
                 "mlir_scf", "mlir_pass", "mlir_side_effect_interfaces",
                 "mlir_standard", "mlir_support",
        ...
        "%{MLIR_GPUTOGPURUNTIMETRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_gpu_to_gpu_runtime_transforms",
                ...
                ["mlir_gpu", "mlir_ir", "mlir_llvm_ir", "mlir_pass",
                 "mlir_support", "mlir_standard_to_llvm", "llvm_core",
                 "llvm_mc", "llvm_support"] +
            ...
            _llvm_get_library_rule(ctx, prx, "mlir_gpu_to_rocdl_transforms",
                ...
                ["mlir_gpu", "mlir_llvm_ir", "mlir_rocdl_ir", "mlir_pass",
                 ...
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_GPUTOSPIRV_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_gpu_to_spirv",
                "MLIRGPUToSPIRV",
                ["mlir_gpu", "mlir_ir", "mlir_pass", "mlir_scf_to_spirv",
                 "mlir_spirv", "mlir_spirv_conversion", "mlir_standard",
                 "mlir_standard_to_spirv", "mlir_support", "mlir_transforms",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_GPUTOVULKANTRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_gpu_to_vulkan_transforms",
                ...
                ["mlir_gpu", "mlir_ir", "mlir_llvm_ir", "mlir_pass",
                 "mlir_spirv", "mlir_spirv_serialization", "mlir_standard",
        ...
        "%{MLIR_JITRUNNER_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_jit_runner",
                ...
                ["mlir_affine", "mlir_affine_edsc", "mlir_affine_transforms",
                 "mlir_affine_utils", "mlir_arm_neon", "mlir_arm_sve",
                 "mlir_async", "mlir_async_transforms", "mlir_avx512",
                 "mlir_complex", "mlir_execution_engine", "mlir_gpu", "mlir_ir",
                 "mlir_llvm_arm_neon", "mlir_llvm_arm_sve", "mlir_llvm_avx512",
                 "mlir_llvm_ir", "mlir_llvm_ir_transforms", "mlir_linalg",
                 "mlir_linalg_analysis", "mlir_linalg_edsc",
                 "mlir_linalg_transforms", "mlir_linalg_utils", "mlir_nvvm_ir",
                 "mlir_open_acc", "mlir_open_mp", "mlir_pdl", "mlir_pdl_interp",
                 "mlir_parser", "mlir_quant", "mlir_rocdl_ir", "mlir_scf",
                 "mlir_scf_transforms", "mlir_sdbm", "mlir_spirv",
                 "mlir_spirv_conversion", "mlir_spirv_module_combiner",
                 "mlir_spirv_transforms", "mlir_spirv_utils", "mlir_shape",
                 "mlir_shape_ops_transforms", "mlir_standard",
                 "mlir_standard_ops_transforms", "mlir_standard_to_llvm",
                 "mlir_support", "mlir_target_llvm_ir", "mlir_tensor",
                 "mlir_tensor_transforms", "mlir_tosa", "mlir_tosa_transforms",
                 "mlir_transforms", "mlir_vector", "llvm_core",
                 "llvm_jit_link", "llvm_orc_jit", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LINALG_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg",
                "MLIRLinalg",
                ["mlir_affine", "mlir_ir", "mlir_side_effect_interfaces",
                 "mlir_view_like_interface", "mlir_standard", "mlir_tensor",
                 "llvm_support"] +
                 (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LINALGANALYSIS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg_analysis",
                "MLIRLinalgAnalysis",
                ["mlir_ir", "mlir_linalg", "mlir_standard", "llvm_support"] +
                 (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LINALGEDSC_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg_edsc",
                "MLIRLinalgEDSC",
                ["mlir_edsc", "mlir_ir", "mlir_affine", "mlir_affine_edsc",
                 "mlir_linalg", "mlir_scf", "mlir_standard",
                 "llvm_support"] +
                 (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LINALGTOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg_to_llvm",
                ...
                ["mlir_affine_to_standard", "mlir_edsc", "mlir_ir",
                 "mlir_linalg", "mlir_llvm_ir", "mlir_scf_to_standard",
                 "mlir_standard_to_llvm", "mlir_transforms",
                 "mlir_vector_to_llvm", "mlir_vector_to_scf",
                 "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LINALGTOSPIRV_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg_to_spirv",
                "MLIRLinalgToSPIRV",
                ["mlir_ir", "mlir_linalg", "mlir_linalg_utils",
                 "mlir_pass", "mlir_spirv", "mlir_spirv_conversion",
                 "mlir_support", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LINALGTOSTANDARD_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg_to_standard",
                "MLIRLinalgToStandard",
                ["mlir_edsc", "mlir_ir", "mlir_linalg", "mlir_pass",
        ...
        "%{MLIR_LINALGTRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg_transforms",
                ...
                ["mlir_affine", "mlir_analysis", "mlir_cast_interfaces",
                 "mlir_edsc", "mlir_ir", "mlir_linalg_analysis",
                 "mlir_linalg_edsc", "mlir_linalg", "mlir_linalg_utils",
                 "mlir_scf", "mlir_scf_transforms", "mlir_pass",
                 "mlir_standard", "mlir_standard_ops_transforms",
                 "mlir_standard_to_llvm", "mlir_tensor",
                 "mlir_transform_utils", "mlir_transforms", "mlir_vector",
                 "mlir_vector_to_scf", "llvm_support"] +
                 (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LINALGUTILS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_linalg_utils",
                "MLIRLinalgUtils",
                ["mlir_affine", "mlir_edsc", "mlir_ir", "mlir_linalg_edsc",
                 "mlir_linalg", "mlir_scf", "mlir_pass", "mlir_standard",
                 "mlir_transform_utils", "llvm_support"] +
                 (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LLVMARMNEON_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_llvm_arm_neon",
                "MLIRLLVMArmNeon",
                ["mlir_ir", "mlir_llvm_ir", "mlir_side_effect_interfaces",
                 "llvm_asm_parser", "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_LLVMARMSVE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_llvm_arm_sve",
                "MLIRLLVMArmSVE",
                ["mlir_ir", "mlir_llvm_ir", "mlir_side_effect_interfaces",
                 "llvm_asm_parser", "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_LLVMIR_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_llvm_ir",
                ...
                ["mlir_call_interfaces", "mlir_control_flow_interfaces",
                 "mlir_ir", "mlir_side_effect_interfaces", "mlir_support",
                 "llvm_asm_parser", "llvm_bit_reader", "llvm_bit_writer",
                 "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_LOOPANALYSIS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_loop_analysis",
                ...
                ["mlir_affine", "mlir_call_interfaces",
                 "mlir_control_flow_interfaces", "mlir_infer_type_op_interface",
                 "mlir_presburger", "mlir_scf", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_MLIROPTMAIN_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_mlir_opt_main",
                "MLIRMlirOptMain",
                ["mlir_affine", "mlir_affine_edsc", "mlir_affine_to_standard",
                 "mlir_affine_transforms", "mlir_affine_utils", "mlir_analysis",
                 "mlir_arm_neon", "mlir_arm_neon_to_llvm", "mlir_arm_sve",
                 "mlir_arm_sve_to_llvm", "mlir_async", "mlir_async_to_llvm",
                 "mlir_async_transforms", "mlir_avx512", "mlir_avx512_to_llvm",
                 "mlir_complex", "mlir_complex_to_llvm", "mlir_dialect",
                 "mlir_edsc", "mlir_gpu", "mlir_gpu_to_gpu_runtime_transforms",
                 "mlir_gpu_to_nvvm_transforms", "mlir_gpu_to_rocdl_transforms",
                 "mlir_gpu_to_spirv", "mlir_gpu_to_vulkan_transforms",
                 "mlir_ir", "mlir_llvm_avx512", "mlir_llvm_arm_neon",
                 "mlir_llvm_arm_sve", "mlir_llvm_ir", "mlir_llvm_ir_transforms",
                 "mlir_linalg", "mlir_linalg_analysis", "mlir_linalg_edsc",
                 "mlir_linalg_to_llvm", "mlir_linalg_to_spirv",
                 "mlir_linalg_to_standard", "mlir_linalg_transforms",
                 "mlir_linalg_utils", "mlir_loop_analysis", "mlir_nvvm_ir",
                 "mlir_open_acc", "mlir_open_mp", "mlir_open_mp_to_llvm",
                 "mlir_opt_lib", "mlir_pdl", "mlir_pdl_interp",
                 "mlir_pdl_to_pdl_interp", "mlir_parser", "mlir_pass",
                 "mlir_quant", "mlir_rocdl_ir", "mlir_scf", "mlir_scf_to_gpu",
                 "mlir_scf_to_open_mp", "mlir_scf_to_spirv",
                 "mlir_scf_to_standard", "mlir_scf_transforms", "mlir_sdbm",
                 "mlir_spirv", "mlir_spirv_conversion",
                 "mlir_spirv_module_combiner", "mlir_spirv_to_llvm",
                 "mlir_spirv_transforms", "mlir_spirv_utils", "mlir_shape",
                 "mlir_shape_ops_transforms", "mlir_shape_to_standard",
                 "mlir_standard", "mlir_standard_ops_transforms",
                 "mlir_standard_to_llvm", "mlir_standard_to_spirv",
                 "mlir_support", "mlir_tensor", "mlir_tensor_transforms",
                 "mlir_tosa", "mlir_tosa_to_linalg", "mlir_tosa_transforms",
                 "mlir_transform_utils", "mlir_transforms", "mlir_vector",
                 "mlir_vector_to_llvm", "mlir_vector_to_rocdl",
                 "mlir_vector_to_scf", "mlir_vector_to_spirv",
                 "llvm_asm_parser", "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_NVVMIR_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_nvvm_ir",
                ...
                ["mlir_ir", "mlir_llvm_ir", "mlir_side_effect_interfaces",
                 "llvm_asm_parser", "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_OPENACC_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_open_acc",
                "MLIROpenACC",
                ["mlir_ir", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_OPENMP_LIB}":
        ...
        "%{MLIR_OPENMPTOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_open_mp_to_llvm",
                "MLIROpenMPToLLVM",
                ["mlir_ir", "mlir_llvm_ir", "mlir_open_mp",
                 "mlir_standard_to_llvm", "mlir_transforms", "llvm_core",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_OPTLIB_LIB}":
        ...
        "%{MLIR_PASS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_pass",
                ...
                ["mlir_analysis", "mlir_ir", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_PDL_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_pdl",
                "MLIRPDL",
                ["mlir_ir", "mlir_infer_type_op_interface",
                 "mlir_side_effect_interfaces", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_PDLINTERP_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_pdl_interp",
                "MLIRPDLInterp",
                ["mlir_ir", "mlir_infer_type_op_interface", "mlir_pdl",
                 "mlir_side_effect_interfaces", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_PDLTOPDLINTERP_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_pdl_to_pdl_interp",
                "MLIRPDLToPDLInterp",
                ["mlir_ir", "mlir_infer_type_op_interface", "mlir_pdl",
                 "mlir_pdl_interp", "mlir_pass", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_PRESBURGER_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_presburger",
                "MLIRPresburger", ["llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_PUBLICAPI_LIB}":
            _llvm_get_shared_library_rule(ctx, prx, "mlir_public_api",
                "MLIRPublicAPI",
                ["mlir_headers", "llvm_headers"] if add_hdrs else []),
        "%{MLIR_PUBLICAPI_COPY_GENRULE}":
            _llvm_get_shared_lib_genrule(ctx, prx, "mlir_copy_public_api",
                llvm_path, "MLIRPublicAPI"),
        "%{MLIR_QUANT_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_quant",
                "MLIRQuant",
                ["mlir_ir", "mlir_pass", "mlir_side_effect_interfaces",
                 "mlir_support", "mlir_standard", "mlir_transform_utils",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_REDUCE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_reduce",
                "MLIRReduce", ["llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_REWRITE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_rewrite",
                "MLIRRewrite",
                ["mlir_ir", "mlir_pdl", "mlir_pdl_interp",
                 "mlir_pdl_to_pdl_interp", "mlir_side_effect_interfaces",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_ROCDLIR_LIB}":
        ...
        "%{MLIR_SCFTOGPU_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_scf_to_gpu",
                "MLIRSCFToGPU",
                ["mlir_affine", "mlir_affine_to_standard", "mlir_complex",
                 "mlir_gpu", "mlir_ir", "mlir_linalg", "mlir_pass",
                 "mlir_standard", "mlir_support", "mlir_transforms",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SCFTOOPENMP_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_scf_to_open_mp",
                "MLIRSCFToOpenMP",
                ["mlir_open_mp", "mlir_scf", "mlir_transforms",
                 "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SCFTOSPIRV_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_scf_to_spirv",
                "MLIRSCFToSPIRV",
                ["mlir_ir", "mlir_pass", "mlir_spirv", "mlir_spirv_conversion",
                 "mlir_standard", "mlir_standard_to_spirv", "mlir_support",
                 "mlir_transforms", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_SCFTRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_scf_transforms",
                "MLIRSCFTransforms",
                ["mlir_affine", "mlir_ir", "mlir_pass", "mlir_scf",
                 "mlir_standard", "mlir_support", "mlir_transform_utils",
                 "mlir_transforms", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SDBM_LIB}":
        ...
        "%{MLIR_SHAPE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_shape",
                "MLIRShape",
                ["mlir_cast_interfaces", "mlir_control_flow_interfaces",
                 "mlir_dialect", "mlir_infer_type_op_interface", "mlir_ir",
                 "mlir_side_effect_interfaces", "mlir_standard",
                 "mlir_tensor", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SHAPEOPSTRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_shape_ops_transforms",
        ...
        "%{MLIR_SHAPETOSTANDARD_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_shape_to_standard",
                "MLIRShapeToStandard",
                ["mlir_edsc", "mlir_ir", "mlir_pass", "mlir_scf", "mlir_shape",
                 "mlir_tensor", "mlir_transforms", "llvm_core",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_SPIRVBINARYUTILS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_spirv_binary_utils",
                "MLIRSPIRVBinaryUtils",
                ["mlir_ir", "mlir_spirv", "mlir_support", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SPIRVCONVERSION_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_spirv_conversion",
                "MLIRSPIRVConversion",
                ["mlir_spirv", "mlir_transform_utils", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SPIRVDESERIALIZATION_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_spirv_deserialization",
                "MLIRSPIRVDeserialization",
                ["mlir_ir", "mlir_spirv", "mlir_spirv_binary_utils", "mlir_support",
                 "mlir_translation", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SPIRVMODULECOMBINER_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_spirv_module_combiner",
        ...
        "%{MLIR_SPIRVTOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_spirv_to_llvm",
                "MLIRSPIRVToLLVM",
                ["mlir_gpu", "mlir_ir", "mlir_llvm_ir", "mlir_spirv",
                 "mlir_spirv_utils", "mlir_standard_to_llvm",
                 "mlir_transforms", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_SPIRVTRANSLATEREGISTRATION_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_spirv_translate_registration",
                "MLIRSPIRVTranslateRegistration",
                ["mlir_ir", "mlir_spirv", "mlir_spirv_deserialization",
                 "mlir_spirv_serialization", "mlir_support", "mlir_translation",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SPIRVUTILS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_spirv_utils",
                "MLIRSPIRVUtils",
                ["mlir_spirv", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_STANDARD_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_standard",
                "MLIRStandard",
                ["mlir_call_interfaces", "mlir_cast_interfaces",
                 "mlir_control_flow_interfaces", "mlir_edsc", "mlir_ir",
                 "mlir_side_effect_interfaces", "mlir_tensor",
                 "mlir_vector_interfaces", "mlir_view_like_interface",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_STANDARDTOSPIRV_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_standard_to_spirv",
                "MLIRStandardToSPIRV",
                ["mlir_ir", "mlir_pass", "mlir_spirv", "mlir_spirv_conversion",
                 "mlir_support", "mlir_transform_utils", "mlir_standard",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_SUPPORT_LIB}":
        ...
        "%{MLIR_SUPPORTINDENTEDOSTREAM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_support_indented_ostream",
                "MLIRSupportIndentedOstream",
                ["llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TABLEGEN_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_tablegen",
                "MLIRTableGen", ["llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TABLEGEN_TOOL}":
            _llvm_get_executable_file_rule(ctx, prx, "mlir_tablegen_tool",
                "mlir-tblgen"),
        "%{MLIR_TARGETARMNEON_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_target_arm_neon",
                "MLIRTargetArmNeon",
                ["mlir_ir", "mlir_llvm_arm_neon", "mlir_llvm_ir",
                 "mlir_target_llvm_ir_module_translation",
                 "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TARGETARMSVE_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_target_arm_sve",
                "MLIRTargetArmSVE",
                ["mlir_ir", "mlir_llvm_arm_sve", "mlir_llvm_ir",
                 "mlir_target_llvm_ir_module_translation",
                 "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_TARGETLLVMIRMODULETRANSLATION_LIB}":
            _llvm_get_library_rule(ctx, prx,
                ...
                ["mlir_llvm_ir", "mlir_llvm_ir_transforms", "mlir_open_mp",
                 "mlir_translation", "llvm_core", "llvm_frontend_open_mp",
                 "llvm_transform_utils", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
            ...
            _llvm_get_library_rule(ctx, prx, "mlir_target_rocdl_ir",
                ...
                ["mlir_gpu", "mlir_ir", "mlir_llvm_ir", "mlir_rocdl_ir",
                 ...
                 "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TENSOR_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_tensor",
                "MLIRTensor",
                ["mlir_cast_interfaces", "mlir_ir",
                 "mlir_side_effect_interfaces", "mlir_support", "llvm_core",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TENSORTRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_tensor_transforms",
                "MLIRTensorTransforms",
                ["mlir_ir", "mlir_pass", "mlir_scf", "mlir_tensor",
                 "mlir_transforms", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TOSA_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_tosa",
                "MLIRTosa",
                ["mlir_call_interfaces", "mlir_control_flow_interfaces",
                 "mlir_dialect", "mlir_ir", "mlir_quant",
                 "mlir_side_effect_interfaces", "mlir_standard",
                 "mlir_view_like_interface", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TOSATOLINALG_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_tosa_to_linalg",
                "MLIRTosaToLinalg",
                ["mlir_ir", "mlir_linalg", "mlir_linalg_utils", "mlir_pass",
                 "mlir_support", "mlir_tosa", "mlir_tosa_transforms",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TOSATRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_tosa_transforms",
                "MLIRTosaTransforms",
                ["mlir_pass", "mlir_tosa", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TRANSFORMS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_transforms",
                "MLIRTransforms",
                ["mlir_affine", "mlir_analysis", "mlir_copy_op_interface",
                 "mlir_linalg", "mlir_loop_like_interface", "mlir_scf",
                 "mlir_pass", "mlir_transform_utils", "mlir_vector",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_TRANSFORMUTILS_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_transform_utils",
                "MLIRTransformUtils",
                ["mlir_affine", "mlir_analysis", "mlir_loop_analysis",
                 "mlir_scf", "mlir_pass", "mlir_rewrite", "mlir_standard",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        ...
        "%{MLIR_VECTOR_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_vector",
                "MLIRVector",
                ["mlir_affine_edsc", "mlir_edsc", "mlir_ir", "mlir_standard",
                 "mlir_affine", "mlir_scf", "mlir_loop_analysis",
                 "mlir_side_effect_interfaces", "mlir_vector_interfaces",
                 "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_VECTORTOLLVM_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_vector_to_llvm",
                "MLIRVectorToLLVM",
                ["mlir_avx512", "mlir_avx512_to_llvm", "mlir_arm_neon",
                 "mlir_arm_neon_to_llvm", "mlir_llvm_arm_neon",
                 "mlir_arm_sve", "mlir_arm_sve_to_llvm", "mlir_llvm_arm_sve",
                 "mlir_llvm_avx512", "mlir_llvm_ir", "mlir_standard_to_llvm",
                 "mlir_target_llvm_ir_module_translation", "mlir_transforms",
                 "mlir_vector", "llvm_core", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_VECTORTOROCDL_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_vector_to_rocdl",
                "MLIRVectorToROCDL",
                ["mlir_rocdl_ir", "mlir_standard_to_llvm", "mlir_vector",
        ...
        "%{MLIR_VECTORTOSPIRV_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_vector_to_spirv",
                "MLIRVectorToSPIRV",
                ["mlir_spirv", "mlir_spirv_conversion", "mlir_transforms",
                 "mlir_vector", "llvm_support"] +
                  (["mlir_headers", "llvm_headers"] if add_hdrs else [])),
        "%{MLIR_VECTORINTERFACES_LIB}":
            _llvm_get_library_rule(ctx, prx, "mlir_vector_interfaces",
